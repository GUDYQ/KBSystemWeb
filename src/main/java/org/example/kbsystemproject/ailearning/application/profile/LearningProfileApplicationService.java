...
public class LearningProfileApplicationService {
    ...
    public Mono<LearningProfileResponse> getProfile(String userId, String subject, String conversationId) {
        ...
        Mono<LearningProfileRecord> profileMono = resolvedSubject == null
                ? Mono.just(new LearningProfileRecord(null, userId, null, null, null, null, List.of(), null))
                : learningProfileStore.findByUserIdAndSubject(userId, resolvedSubject)
    ...
    public Mono<LearningProfileResponse> updateProfile(LearningProfileUpdateRequest request) {
        ...
        if (resolvedSubject == null) {
            return getProfile(request.userId(), null, null);
        }
